  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-[1080px] px-5 pb-24 pt-8 sm:px-8 sm:pt-12">
        ...
        <ReadNext
          groups={[
            { title: navT('readNext'), links: articlesForTool(locale, '/moon-sign-calculator') },
            { title: navT('otherCalculators'), links: await otherCalculators(locale, '/moon-sign-calculator') },
          ]}
        />
      </main>
    </>
