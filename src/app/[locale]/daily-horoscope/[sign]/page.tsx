...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: t('signLead', { sign: label }),
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-[800px] px-5 pb-24 pt-8 sm:px-8 sm:pt-12">
        <Link href={HOROSCOPE_PATH} className="font-mono text-caption text-gold hover:text-ink">
          ← {t('allSigns')}
        </Link>
        ...
        <HoroscopePicker active={slug} labels={labels} />
