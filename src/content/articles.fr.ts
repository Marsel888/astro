...
export const frArticles: Record<string, ArticleCopy> = {
  'what-is-a-natal-chart': {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Vous en avez besoin pour l’Ascendant et les maisons. Sans heure, les signes planétaires restent utilisables. Meridian calcule les planètes et omet le signe Ascendant si vous marquez l’heure comme inconnue.',
      },
      {
        q: 'Quel zodiaque utilise un thème natal ?',
        a: 'Les thèmes natals occidentaux, y compris Meridian, utilisent le zodiaque tropical mesuré depuis l’équinoxe de printemps. Les thèmes sidéraux (védiques) utilisent un zéro stellaire et auront l’air décalés d’environ un signe pour beaucoup de positions aujourd’hui.',
      },
      {
  ...
  'natal-chart-vs-horoscope': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Une lecture de transits pour votre thème natal enregistré est plus proche d’un horoscope personnel qu’une chronique de journal, parce qu’elle utilise vos positions réelles. L’espace quotidien de Meridian stocke ces transits à midi dans le fuseau natal. Ce n’est toujours pas le thème natal. Le thème natal ne change pas ; le ciel au-dessus de lui, si.',
        ],
      },
      {
        heading: 'Ce que Meridian calcule',
        paragraphs: [
          'Meridian calcule des thèmes natals, des outils de signe planète par planète, des roues de synastrie et de composite. Les positions viennent d’astronomy-engine (VSOP87), pas de Swiss Ephemeris. Le zodiaque est tropical, pas sidéral ni chinois. Les maisons sont Placidus sauf si vous passez à Whole Sign. Heure inconnue : planètes oui, maisons non.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Le thème natal est la ligne de base. Le langage semaine par semaine appartient aux transits contre cette ligne de base. Meridian stocke les transits quotidiens à midi dans le fuseau natal ; ce n’est toujours pas un horoscope de journal.',
      },
      {
  ...
  'what-is-my-sun-sign': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Lisez le Soleil comme l’intrigue diurne : ce que vous faites quand vous êtes le plus visiblement vous-même dans le temps public. Puis lisez le reste. Un thème qui ne liste que le Soleil est un titre. Les tableaux sous la roue de Meridian sont l’article.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'L’histoire des fuseaux compte plus qu’on ne croit. Une naissance notée 23:40 dans une ville encore à l’heure d’été peut être un Temps universel différent de la même lecture d’horloge en hiver. Meridian utilise les règles IANA pour cette date. Si un vieux papier utilisait un autre décalage, le degré du Soleil peut bouger ; sur une cuspide, le signe aussi.',
        ],
      },
      {
        heading: 'Trouver votre signe solaire sur Meridian',
        paragraphs: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Les applications védiques utilisent en général le zodiaque sidéral. Meridian utilise des longitudes tropicales depuis l’équinoxe. L’écart est d’environ 24° aujourd’hui, ce qui déplace souvent le Soleil dans le signe précédent.',
      },
      {
  ...
  'sun-moon-rising': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Sans heure de naissance, le signe de la Lune est en général encore juste. Le degré et la maison ne le sont pas. Si la Lune a changé de signe le jour de votre naissance, une heure inconnue laisse la Lune elle-même non tranchée. Marquez l’heure inconnue dans Meridian plutôt que d’inventer midi et de défendre le degré.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Les maisons en Placidus (le défaut de Meridian) partent de cet angle. Pas d’Ascendant fiable veut dire pas de maisons fiables. Si vous n’avez pas d’heure, sautez l’Ascendant. Un signe Ascendant deviné décale chaque ligne « planète en maison » qui le suit.',
        ],
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Soleil en général oui, Lune en général oui sauf les jours de changement de signe, Ascendant non. Meridian omet l’Ascendant lorsque l’heure est marquée inconnue.',
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Lorsque les deux sont connus, lisez-les comme des objets différents. Soleil en Vierge, Ascendant Scorpion est un schéma courant, pas une contradiction. L’un est l’intrigue solaire ; l’autre est la porte est et la grille des maisons. Le calculateur d’ascendant de Meridian est le moteur natal filtré sur cet angle. Le thème complet montre encore pourquoi le reste du ciel siège où il siège.',
        ],
      },
      {
        heading: 'Les maisons commencent à l’Ascendant',
        paragraphs: [
          'En Placidus, le défaut de Meridian, la maison I commence à l’Ascendant. Le reste des cuspides suit le temps d’ascension, donc les maisons sont inégales. Whole Sign attribue la maison I à tout le signe qui contient l’Ascendant, puis compte les signes. Dans les deux cas, pas d’Ascendant veut dire pas de maisons honnêtes.',
    ...
    faq: [
      {
        ...
        a: 'Non. L’Ascendant est un degré d’horizon. Sans horloge et sans lieu, tout signe Ascendant est une estimation. Meridian l’omet lorsque l’heure est inconnue.',
      },
      {
      ...
      },
      {
        ...
        a: 'Vérifiez le fuseau, l’heure d’été, les coordonnées, et si l’autre site est sidéral. Meridian est tropical Placidus par défaut. Un substitut de midi produit aussi un faux Ascendant.',
      },
    ],
  },
  'moon-sign': {
    ...
    faq: [
      {
        ...
        a: 'Calculez un thème natal à partir de la date, de l’heure et du lieu de naissance. La ligne Lune est le signe tropical. Le calculateur de signe lunaire de Meridian utilise le même moteur que le thème complet.',
      },
      {
      ...
      },
      {
        ...
        a: 'Les zodiaques sidéraux mesurent depuis un zéro stellaire éloigné d’environ 24° de l’équinoxe tropical aujourd’hui. Meridian est tropical seulement.',
      },
    ],
  },
  'venus-sign': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Le signe Ascendant a encore besoin de l’horloge. Si vous n’êtes venu que pour Vénus et que vous avez une heure, saisissez-la quand même pour que maison et aspects soient réels. Le calculateur de signe de Vénus de Meridian est le moteur natal filtré sur un glyphe. Le thème complet est le contexte qui empêche Vénus de manger toute la lecture.',
        ],
      },
      {
        heading: 'Maisons et aspects à Vénus',
        paragraphs: [
          'Avec un Ascendant connu, Vénus dans une maison nomme le domaine de vie où cette fonction d’évaluation est évidente — quatre, sept, dix, et ainsi de suite. Les maisons vides ailleurs ne sont pas des organes manquants. Placidus est le défaut de Meridian ; Whole Sign est l’alternative lorsque vous voulez des signes égaux ou lorsque vous êtes à haute latitude.',
      ...
      },
      {
        ...
        paragraphs: [
          'Saisissez date, heure et lieu de naissance dans Meridian. Lisez la ligne Vénus. Comparez avec le Soleil : souvent à proximité, parfois le même. Si une application sidérale n’est pas d’accord, vous regardez un zéro différent, éloigné d’environ 24°. Passez cette application en tropical si vous voulez coller à ce site.',
    ...
    faq: [
      {
        ...
        a: 'Lancez un thème natal ou le calculateur de signe de Vénus de Meridian avec votre date de naissance, et ajoutez l’heure et le lieu si vous les avez. La ligne Vénus est le signe tropical et le degré.',
      },
      {
  ...
  'mercury-sign': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Les aspects majeurs sont conjonction, sextile, carré, trigone et opposition. Les orbes de Meridian sont 8° pour la conjonction et l’opposition, 6° pour le carré et le trigone, 4° pour le sextile. Des contacts serrés Mercure–Saturne ou Mercure–Uranus diront plus que le texte du signe. Utilisez le tableau sous la roue.',
    ...
    faq: [
      {
        ...
        a: 'Calculez un thème natal à partir de la date, de l’heure et du lieu de naissance, ou utilisez le calculateur de signe de Mercure de Meridian. La ligne Mercure est le signe tropical et le degré.',
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Meridian place Mars dans le zodiaque tropical avec astronomy-engine (VSOP87). Les maisons, lorsque l’horloge est connue, sont Placidus par défaut. Les systèmes sidéraux et chinois sont hors champ. Si une application védique montre un autre signe de Mars, vous regardez un autre zéro, pas une autre planète.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Les transits à Mars natal sont une météo plus tardive. L’espace de Meridian stocke la superposition du jour à midi dans le fuseau natal. Un carré de Mars en transit à Mars natal est un contact temporaire, pas une réécriture du signe natal de Mars. Gardez la ligne de base et la météo dans des tiroirs différents.',
      ...
      },
      {
        ...
        paragraphs: [
          'Utilisez le calculateur de signe de Mars ou le thème natal complet sur Meridian. Saisissez date, heure et lieu. Lisez la ligne Mars, puis les aspects. Tropical seulement. Alignez les autres sites en les réglant sur tropical plus Placidus si vous voulez les mêmes maisons.',
    ...
    faq: [
      {
        ...
        a: 'Calculez un thème natal ou utilisez le calculateur de signe de Mars de Meridian avec la date, l’heure et le lieu de naissance. La ligne Mars est le signe tropical et le degré.',
      },
      {
  ...
  'why-birth-time-matters': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Les maisons sont des secteurs du ciel local, pas des signes. Les signes sont 30° du zodiaque tropical. Les maisons, c’est ce que vous obtenez lorsque vous divisez l’espace autour de l’horizon et du méridien. Placidus, le défaut de Meridian, divise le temps d’ascension, donc les maisons sont inégales. Whole Sign donne à chaque maison un signe entier à partir du signe de l’Ascendant.',
          'Sans heure de naissance, il n’y a pas d’Ascendant honnête et donc pas de maisons honnêtes. Heure inconnue = planètes oui, maisons non. Meridian suit cette règle au lieu de vous parquer silencieusement à midi. Midi est une convention pour certains thèmes historiques ; ce n’est pas votre Ascendant.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Les aspects entre planètes existent encore sans maisons. Meridian listera les aspects majeurs dans les orbes de 8° / 6° / 4° à partir des longitudes planétaires même lorsque l’Ascendant est omis. Ce que vous perdez, c’est tout ce qui a besoin d’un angle : signe Ascendant, cuspides de maisons, planètes au Milieu du Ciel.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Ne rectifiez pas une heure pour coller à une biographie dans ce calculateur. Meridian n’inventera pas une minute pour que la maison dix ressemble à votre titre de poste. Si l’heure est inconnue, marquez-la inconnue. Lisez les planètes en signes et les aspects. Laissez les maisons pour un jour où vous aurez une horloge.',
          'Les dossiers d’hôpital battent les estimations de baptême. Une heure écrite 16 h 30 vaut mieux que « fin d’après-midi ». Si le document utilise une ancienne heure locale moyenne, dites-le lorsque vous comparez avec un autre site ; la conversion IANA suppose le fuseau civil de cette date, c’est ce que Meridian applique.',
        ],
      },
      {
        heading: 'Que saisir sur Meridian',
        paragraphs: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Il peut estimer les signes planétaires un jour calme. Ce n’est pas un Ascendant ni un système de maisons exacts. Meridian traite l’heure inconnue comme des planètes seulement.',
      },
      {
      ...
      },
      {
        ...
        a: 'Vous pouvez comme esquisse pour les signes. N’en lisez pas les maisons ni l’Ascendant. Marquez l’heure inconnue sur Meridian plutôt que de prétendre que midi est un fait.',
      },
    ],
  },
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Meridian vous laisse marquer l’heure comme inconnue, puis renvoie les planètes tout en omettant le signe Ascendant. C’est le bon produit. Beaucoup de sites utilisent silencieusement 12:00 et dessinent quand même des maisons. Ces maisons appartiennent à qui est né à midi, ce qui n’est pas un fait à votre sujet.',
        ],
      },
      {
        heading: 'Ce que vous obtenez encore : les signes planétaires',
        paragraphs: [
          'Le Soleil, Mercure, Vénus, Mars et les planètes externes bougent assez lentement pour qu’une date calendaire verrouille en général le signe. Les aspects entre ces corps sont aussi utilisables, avec les orbes de Meridian de 8° conjonction et opposition, 6° carré et trigone, 4° sextile. Vous pouvez lire beaucoup d’un thème ainsi : équilibre des éléments, un stellium dans un signe, un carré serré de Saturne au Soleil.',
    ...
    faq: [
      {
        ...
        a: 'Vous pouvez dresser les signes planétaires et les aspects. Vous ne pouvez pas dresser un Ascendant ou des maisons fiables. Meridian marque cette limite lorsque l’heure est inconnue.',
      },
      {
  ...
  'how-to-read-a-natal-chart': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Si vous n’avez que le Soleil, vous ne savez pas encore lire le thème ; vous connaissez une coordonnée. La roue de Meridian place ces trois glyphes où vous pouvez les voir avant de chasser des astéroïdes ou des points hypothétiques que ce site n’utilise pas.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Meridian est Placidus par défaut parce que la plupart des textes occidentaux le supposent. Whole Sign est l’autre grille. Les latitudes polaires au-dessus d’environ 66° ne doivent pas forcer des cuspides Placidus cassées. Si l’heure est inconnue, sautez toute cette étape. Un langage planète-en-maison sans Ascendant est une fiction.',
        ],
      },
      {
        heading: 'Puis lisez les aspects les plus serrés',
        paragraphs: [
          'Les aspects sont des angles nommés : conjonction, sextile, carré, trigone, opposition. Classez par orbe, le plus serré d’abord. Une conjonction Soleil–Saturne de 0,4° passe avant un trigone de Mars de 7,8°. Meridian dessine les cinq majeurs et liste appliquant ou séparant dans le tableau. Cachez les lignes sur la roue si le dessin est bruyant ; le tableau reste.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Lisez seulement les signes planétaires et les aspects. Sautez l’Ascendant et toutes les affirmations de maisons. Meridian omet l’Ascendant lorsque l’heure est inconnue.',
      },
      {
      ...
      },
      {
        ...
        a: 'Meridian utilise 8° pour la conjonction et l’opposition, 6° pour le carré et le trigone, 4° pour le sextile. Les orbes plus serrés d’abord.',
      },
    ],
  },
  'houses-in-a-birth-chart': {
    ...
    excerpt:
      'Les maisons sont douze secteurs locaux du ciel de naissance, pas des signes du zodiaque. Elles ont besoin d’une heure de naissance. Meridian est Placidus par défaut ; heure inconnue veut dire pas de maisons honnêtes.',
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Vous ne pouvez pas avoir de maisons sans heure de naissance, parce que le cadre est lié à l’horizon. Heure inconnue = planètes oui, maisons non. Les gens qui publient des lectures de maisons à partir d’un substitut de midi décrivent midi, pas une minute inconnue. Meridian ne fait pas cela par défaut.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Nominatim d’OpenStreetMap fournit les coordonnées que Meridian utilise pour le lieu. Une épingle centre-ville n’est pas une épingle d’hôpital ; pour les maisons la différence est en général petite, mais à haute latitude ou près d’une cuspide elle peut compter. Préférez la vraie ville de naissance à une ville d’adoption plus tardive.',
        ],
      },
      {
        heading: 'Comment lire les maisons sur la roue',
        paragraphs: [
          'Sur Meridian, les divisions intérieures sont les maisons, comptées depuis l’Ascendant à gauche. Les glyphes siègent sur la longitude écliptique ; le tableau vous dit dans quel numéro de maison cette longitude est tombée. Les aspects restent sur l’écliptique (orbes 8° / 6° / 4°) et ne se soucient pas des murs de maisons. Les murs de maisons se soucient de l’horloge.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Placidus est le défaut de Meridian et correspond à la plupart des textes occidentaux. Utilisez Whole Sign aux hautes latitudes ou si vous voulez un signe par maison.',
      },
      {
  ...
  'empty-houses': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Sans heure de naissance, chaque affirmation de maison vide est invalide, parce que les murs sont invalides. N’utilisez pas un thème 12:00 pour annoncer que votre maison quatre est vide. Marquez l’heure inconnue sur Meridian et sautez les maisons. Vous pouvez encore parler de signes vides — aucune planète en Scorpion, par exemple — parce que les signes n’ont pas besoin de l’horizon.',
      ...
      {
        heading: 'Comment les lire sur Meridian',
        paragraphs: [
  ...
  'aspects-in-astrology': {
    ...
    excerpt:
      'Les aspects sont des angles nommés entre planètes le long de l’écliptique : conjonction, sextile, carré, trigone, opposition. Meridian utilise des orbes de 8°, 6° et 4° pour ces cinq-là.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Un orbe, c’est de combien le contact peut s’écarter de l’exact et compter encore. La pile de Meridian est 8° / 6° / 4° comme ci-dessus. Une conjonction Soleil–Lune à 7,2° compte ; un sextile de Mercure à 4,5° ne compte pas. D’autres logiciels utilisent d’autres orbes, c’est pourquoi les listes d’aspects divergent même lorsque les longitudes collent.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Les aspects mineurs (quinconce, semi-carré, et le reste) ne sont pas dessinés ici. Si un autre site montre plus de lignes, il utilise un catalogue plus large, pas un ciel plus exact. Meridian reste aux cinq majeurs sur des longitudes tropicales d’astronomy-engine (VSOP87), pas Swiss Ephemeris.',
      ...
      {
        heading: 'Comment Meridian montre les aspects',
        paragraphs: [
    ...
    faq: [
      {
        ...
        a: 'Conjonction, sextile, carré, trigone et opposition. Ce sont les cinq que Meridian dessine. Les orbes sont 8°, 6° et 4° selon l’aspect.',
      },
      {
        q: 'Que veut dire orbe en astrologie ?',
        a: 'De combien de degrés un aspect peut s’écarter de l’exact et compter encore. Les orbes plus serrés sont plus forts sur l’instrument. Le jeu de Meridian est 8° / 6° / 4°.',
      },
      {
  ...
  'tropical-vs-sidereal': {
    ...
    excerpt:
      'Le zodiaque tropical commence à l’équinoxe de mars. Le sidéral utilise un zéro stellaire, éloigné d’environ 24° aujourd’hui. Meridian est tropical seulement — pas védique, pas Swiss Ephemeris.',
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Cet écart est la raison pour laquelle votre signe solaire dans une application védique est souvent le signe précédent comparé à Meridian. Ni l’un ni l’autre calculateur n’a « tort sur le ciel ». Ils utilisent des origines différentes pour la même ceinture nommée. Meridian est tropical : convention occidentale, fondé sur l’équinoxe, astronomy-engine (VSOP87). Il ne calcule pas les systèmes sidéraux, védiques ou chinois.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Les transits dans l’espace de Meridian sont des transits tropicaux stockés à midi dans le fuseau natal. Mélanger un natal tropical avec des transits sidéraux, c’est la même erreur de 24° en mouvement. Gardez le zodiaque cohérent. Le thème natal est la ligne de base ; les transits sont la météo contre cette ligne de base, dans le même système de coordonnées.',
          'Si vous publiez un thème, nommez le zodiaque dans la légende : tropical, Placidus, heure de naissance connue ou inconnue. Cette seule ligne prévient la plupart des fils « votre calculateur a tort ». La légende de Meridian montre déjà tropical et Placidus lorsque la roue est complète.',
        ],
      },
    ],
    faq: [
      ...
      {
        q: 'Quel zodiaque Meridian utilise-t-il ?',
  ...
  'synastry-vs-composite': {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Meridian offre les deux comme calculateurs séparés. Chaque natal est tropical, Placidus par défaut, VSOP87 via astronomy-engine. Les aspects de synastrie utilisent les mêmes orbes qu’un aspectaire natal : 8° conjonction et opposition, 6° carré et trigone, 4° sextile. Ni l’une ni l’autre roue n’est un verdict sur le fait de rester ensemble, de se marier ou de partager des biens. Ce sont des diagrammes.',
        ],
      },
      {
        heading: 'Ce que fait la synastrie',
        paragraphs: [
          'La synastrie laisse les deux thèmes intacts. Sur Meridian, un jeu de glyphes est la personne A, l’autre la personne B. Le tableau liste les aspects inter-thèmes, pas les aspects internes d’un natal. Vous demandez ce qui se passe lorsque deux ciels partagent une cuisine : son Saturne sur sa Lune, son Mars sur son Ascendant, un trigone Soleil–Soleil.',
      ...
      {
        heading: 'Comment les lancer sur Meridian',
        paragraphs: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Non. Le composite utilise des milieux planétaires. Davison prend le milieu des deux heures et lieux de naissance en un événement hypothétique. Le composite de Meridian est la roue des milieux.',
      },
    ],
  },
  'what-are-transits': {
    ...
    excerpt:
      'Les transits sont les positions d’aujourd’hui comparées à votre thème natal. C’est de la météo contre une ligne de base fixe, pas un nouveau thème de naissance. Meridian les stocke à midi.',
    sections: [
      {
      ...
      {
        heading: 'Pourquoi Meridian utilise midi dans le fuseau natal',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Gardez les transits tropicaux sur un natal tropical. Des transits sidéraux sur un natal tropical mélangent les zéros et gaspillent l’écart de 24°. Meridian ne fera pas ce mélange. Les maisons natales Placidus, si elles existent, sont les pièces que les transits traversent. Les maisons natales vides peuvent encore recevoir des transits ; le vide concernait les planètes natales, pas une interdiction de trafic plus tardif.',
        ],
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Non. Les transits se superposent au natal. Meridian stocke la superposition de chaque jour à midi dans le fuseau natal. Vos positions de naissance ne bougent pas.',
      },
      {
        q: 'Pourquoi Meridian calcule-t-il les transits quotidiens à midi ?',
